    ...
    <body>
        ...
        <section class='container p-4'>
	        	...
	        	<c:if test="${result!=null}">
	               ...
	               <input type="text" class="form-control" placeholder="Enter name" id="j_name" name="jname" required>
	             </div>
	             <div class="form-group">
	               <label >Job Location:</label>
	               <input type="text" class="form-control" placeholder="Job Location" id="j_location" name="location" required>
	             </div>
	             <div class="form-group">
	               <label >Category:</label>
	               Tech <input type="radio" class="form-control" name="category" value='Tech' checked>
	               Non-Tech <input type="radio" class="form-control" name="category" value='Non-Tech' checked>
	             </div>
	             <div class="form-group">
	               <label >Job Description:</label>
	               <textarea rows='3' class="form-control" placeholder="Job Description" name="description" required></textarea>
	             </div>
	             <div class="form-group">
	               <label >Job Requirements :</label>
	               <textarea rows='3' class="form-control" placeholder="Job Requirements" name="expreience" required></textarea>
	             </div>
